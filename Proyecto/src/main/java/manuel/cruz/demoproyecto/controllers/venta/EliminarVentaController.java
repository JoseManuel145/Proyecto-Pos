...
public class EliminarVentaController {
    ...
    public void onMouseClickedEliminarButton(){
        ...
        if (elimino){
            App.showAlert(Alert.AlertType.INFORMATION,"Eliminar Producto", "El producto se elimino correctamente");
        } else {
            App.showAlert(Alert.AlertType.ERROR,"Eliminar Producto","Fallo al eliminar.\nNo se encontro el producto");
        }
    }
